...
export function aesEncrypt(text) {
    ...
    try {
        ...
        const ret = wasm.aesEncrypt(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
...
export function getBrowserFingerprint() {
    const ret = wasm.getBrowserFingerprint();
    let v1;
    if (ret[0] !== 0) {
 ...
 * @returns {string}
 */
export function encryptAppSecret(app_secret) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(app_secret, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.encryptAppSecret(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @returns {string}
 */
export function decryptAppSecret(encrypted_data) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(encrypted_data, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.decryptAppSecret(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
...
export function rsaEncrypt(data) {
    ...
    try {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.rsaEncrypt(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
...
/**
 * 使用 appKey 和 appSecret 进行签名。
 * @param {string} app_key
 * @param {string} app_secret
 * @param {any} params
 * @returns {any}
 */
export function sign(app_key, app_secret, params) {
    const ptr0 = passStringToWasm0(app_key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(app_secret, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.sign(ptr0, len0, ptr1, len1, params);
    if (ret[2]) {
...
/**
 * 使用 appKey 和 加密过的 appSecret 进行签名。
 * @param {string} app_key
 * @param {string} encrypted_app_secret
 * @param {any} params
 * @returns {any}
 */
export function secureSign(app_key, encrypted_app_secret, params) {
    const ptr0 = passStringToWasm0(app_key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(encrypted_app_secret, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.secureSign(ptr0, len0, ptr1, len1, params);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
/**
 * 使用 VAC 默认的 appKey 和 appSecret 进行签名。
 * @param {any} params
 * @returns {any}
 */
export function vacSign(params) {
    const ret = wasm.vacSign(params);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_colorDepth_59677c81c61d599a = function() { return handleError(function (arg0) {
    ...
    imports.wbg.__wbg_createLinearGradient_d9f235a84f77b603 = function() { return logError(function (arg0, arg1, arg2, arg3, arg4) {
    ...
    imports.wbg.__wbg_firstChild_b0603462b5172539 = function() { return logError(function (arg0) {
    ...
    imports.wbg.__wbg_language_d871ec78ee8eec62 = function() { return logError(function (arg0, arg1) {
    ...
    imports.wbg.__wbg_languages_d8dad509faf757df = function() { return logError(function (arg0) {
    ...
    imports.wbg.__wbg_setfillStyle_42e38d3d485e9a92 = function() { return logError(function (arg0, arg1) {
        arg0.fillStyle = arg1;
    }, arguments) };
    ...
    imports.wbg.__wbg_tagName_b284ab9c1479c38d = function() { return logError(function (arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('web_crypto_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
